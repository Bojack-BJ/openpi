...
REPO=/mnt/shared-storage-gpfs2/internvla-gpfs2/zhaxizhuoma/openpi
export PYTHONPATH="$REPO/src:$REPO/packages/openpi-client/src:$PYTHONPATH"

cfg=pi0_Fold_square_towels_gripper_delta

# cp /mnt/shared-storage-user/internvla/Users/liyang/download/big_vision/* /home/zhaxizhuoma/.cache/openpi/big_vision/
...
cd /mnt/shared-storage-gpfs2/internvla-gpfs2/zhaxizhuoma/openpi
