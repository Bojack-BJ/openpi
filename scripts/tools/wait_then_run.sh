...
保存log版（推荐）：
bash /root/Users/lixiaotong/openpi/scripts/tools/wait_then_run.sh 1119132 /root/Users/lixiaotong/openpi/scripts/tools/test.sh 300 2>&1 | tee -a /root/Users/lixiaotong/openpi/scripts/wait_then_run_f.log
后台运行版：
nohup bash /root/Users/lixiaotong/openpi/scripts/tools/wait_then_run.sh <当前训练PID> \
