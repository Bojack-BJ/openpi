...
- A zero-shot inference entrypoint for your own single-view or left/right view videos is available at
  [`scripts/hl_memory/run_hl_memory_zero_shot.py`](scripts/hl_memory/run_hl_memory_zero_shot.py)
...
- CrossTask smoke workflow: [`scripts/hl_memory/hl_memory_crosstask_smoke.sh`](scripts/hl_memory/hl_memory_crosstask_smoke.sh)
